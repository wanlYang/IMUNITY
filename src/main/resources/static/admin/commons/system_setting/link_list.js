layui.use(['form','layer','laydate','table','upload'],function(){
    ...
    var tableIns = table.render({
        elem: '#linkList',
        url :  getRealPath() + '/admin/static/json/linkList.json',
        page : true,
        cellMinWidth : 95,
        height : "full-104",
        limit : 20,
    ...
    function addLink(){
        var index = layer.open({
            ...
            type : 2,
            area : ["300px","385px"],
            content : getRealPath() +  "/admin/manager/system_setting/link/add",
    ...
    table.on('tool(linkList)', function(obj){
        ...
        if(layEvent === 'edit'){ //编辑
        	var index = layer.open({
                ...
                type : 2,
                area : ["300px","385px"],
                content : getRealPath() +  "/admin/manager/system_setting/link/edit",
                success : function(layero, index){
                    var body = $($(".layui-layer-iframe",parent.document).find("iframe")[0].contentWindow.document.body);
                    /*if(edit){
                        body.find(".linkLogo").css("background","#fff");
    ...
    upload.render({
        elem: '.linkLogo',
        url: getRealPath() + '/admin/static/json/linkLogo.json',
