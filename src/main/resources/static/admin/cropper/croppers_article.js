...
}).define(['jquery','layer','cropper_article'],function (exports) {
    var $ = layui.jquery
        ,layer = layui.layer;
    var html = "<link rel=\"stylesheet\" href="+getRealPath()+"\"/static/admin/static/cropper/cropper.css\">\n" +
        ...
        "        </div>\n" +
        "        <div class=\"layui-form-mid layui-word-aux\">缩略图的尺寸限定300x150px,大小在5m以内</div>\n" +
        "    </div>\n" +
        ...
        "            <div class=\"img-preview\" style=\"width:200px;height:100px;overflow:hidden;\">\n" +
        "            </div>\n" +
        "        </div>\n" +
        "    </div>\n" +
        "    <div class=\"layui-row layui-col-space15\">\n" +
